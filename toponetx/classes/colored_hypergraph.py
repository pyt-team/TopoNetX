...
class ColoredHyperGraph(Complex):
    ...
    #             raise ValueError(f"color must be an integer, got {rank}")
    #
    #         if rank < 0:
    #             raise ValueError(f"color must be non-negative integer, got {rank}")
    #
    #         if isinstance(hyperedge, str):
    #             if rank != 0:
    #                 raise ValueError(f"color must be zero for string input, got rank {rank}")
    #             else:
    #                 if 0 not in self._complex_set.hyperedge_dict:
    #                     self._complex_set.hyperedge_dict[0] = {}
    ...
    #         if isinstance(hyperedge, Hashable) and not isinstance(hyperedge, Iterable):
    #             if rank != 0:
    #                 raise ValueError(f"color must be zero for hashables, got rank {rank}")
    #             else:
    #                 if 0 not in self._complex_set.hyperedge_dict:
    #                     self._complex_set.hyperedge_dict[0] = {}
    #                 self._complex_set.hyperedge_dict[0][frozenset({hyperedge})] = {}
