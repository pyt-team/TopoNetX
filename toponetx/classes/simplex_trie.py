...
class SimplexNode(Generic[ElementType]):
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"SimplexNode({self.label}, {self.elements}, {self.children})"
...
class SimplexTrie(Generic[ElementType]):
    """
    Implementation of the simplex tree data structure as presented in [1]_.
