    ...
    **attr : keyword arguments, optional
    ...
    def __init__(
        ...
        **attr,
        ...
        """Initialize an instance of the class representing a simplex in a simplicial complex.
        ...
        **attr : keyword arguments, optional
        ...
        super().__init__(tuple(sorted(elements)), **attr)
    ...
    def clone(self) -> "Simplex[ElementType]":
